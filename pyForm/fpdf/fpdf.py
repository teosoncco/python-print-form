...
# ------------------------------------------------------------------------------
# NOTAS LAMBDA 2007/08/08:
# formato: este archivo se paso a standard unix (LF) y 4 espacios por tab
# se cambiaron los nombres de archivo y se saco el __init__ para compatibilidad
# las fuentes se copiaron al final de este archivo para evitar problemas en
#   windows (el instalador no copiaba los fonts)
# is_string (de PHPutils) se modifico para tener en cuenta los unicodes
# se modificó para tirar una excepcion en vez de finalizar
# se modificó/ocrrigio _dochecks para evitar problemas en "hernandez"
# ------------------------------------------------------------------------------
